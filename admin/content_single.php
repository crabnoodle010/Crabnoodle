...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="31" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		...
		<th width="136" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên</a></th>
		<!--<th width="155" class="title"><a class="title" href="<?php echo getLinkSort(5)?>">Nội dung ngắn</a></th>-->
		<th width="110" class="title"><a class="title" href="<?php echo getLinkSort(6)?>">Nội dung </a></th>
		<!--<th width="20" class="title"><a class="title" href="<?php echo getLinkSort(8)?>">Hình ảnh</a></th>-->
		<th width="88" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="112" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="114" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="65" class="title"><a class="title" href="<?php echo getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
