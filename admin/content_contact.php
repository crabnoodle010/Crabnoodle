...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="193" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên</a></th>
		<th width="126" align="center" class="title"><a class="title" href="<?php echo getLinkSort(5)?>">Hotline</a></th>
		<th width="169" class="title"><a class="title" href="<?php echo getLinkSort(6)?>">Nội dung</a></th>		
		<th width="100" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="170" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="151" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
...
while($row=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td bgcolor="<?php echo $color?>" class="smallfont" align="center"><?php echo $row['subject']!=''?'...':'&nbsp;'?></td>
