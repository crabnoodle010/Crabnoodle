...
<?php if ($image!=''){ echo '<img border="0" src="../'.$image.'" width="100"><br><br>Hình ảnh';}?>								</td>																
								<td width="15%"></td>
							</tr>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input value="<?php echo $name?>" type="text" name="txtName" class="textbox" size="50">					</td>
				</tr>
				<tr>
					<td width="15%" class="smallfont" align="right">Địa chỉ: </td>
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<input value="<?php echo $code?>" type="text" name="txtCode" class="textbox" size="50">					</td>
				</tr>
				...
				<!--<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont"><textarea name="txtDetailShort" id="txtDetailShort" cols="80" rows="10"><?php echo $detail_short?>
					</textarea></td>
				</tr>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<?php echo comboCategory('ddCat',$arraySourceCombo,'smallfont',$parent,0)?>					</td>
				</tr>
				...
				<tr>
					...
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<input type="checkbox" name="chkStatus" value="on" <?php echo $status>0?'checked':''?>>					</td>
				</tr>
