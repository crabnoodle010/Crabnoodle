<?php // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_logo'" : "code='vn_logo' or code='en_logo'";
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="300" class="title"><a class="title" href="<?php echo getLinkSort(2)?>">Địa chỉ website</a></th>
		<th width="210" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="70" class="title"><a class="title" href="<?php echo getLinkSort(8)?>">Hình</a></th>
		<th width="100" class="title"><a class="title" href="<?php echo getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="111" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
...
?>
	...
	<tr>
		...
		<!--<td width="29" align="center" bgcolor="<?php echo $color?>" class="smallfont">
			<a onClick="return confirm('Bạn có chắc chắn muốn xóa ?');" href="./?act=<?php echo $actConfig ?>&action=del&page=<?php echo $_REQUEST['page']?>&id=<?php echo $row['id']?>">Xóa</a></td>-->
