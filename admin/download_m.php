...
if (isset($_POST['btnSave'])){
	...
	$errMsg .= checkUpload($_FILES["txtImage"],".doc;.xls;.pdf",10240*10240,0);
...
<?php if ($image!=''){ echo $image;}?>
				...
				<tr>
					<td width="15%" class="smallfont" align="right">Bảng giá
					<td width="1%" class="smallfont" align="center"></td>
					<td width="83%" class="smallfont">
						<input type="file" name="txtImage" class="textbox" size="34">
						<input type="checkbox" name="chkClearImg" value="on" /> Xóa bảng giá						
					</td>
				</tr>
				<tr>
