...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="29" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		...
		<th width="170" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên</a></th>
		<th width="90" class="title"><a class="title" href="<?php echo getLinkSort(5)?>">Nội dung </a></th>		
		<th width="80" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="70" class="title"><a class="title" href="<?php echo getLinkSort(10)?>">Thứ tự</a></th>
		<th width="134" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="134" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
