<?php // Config
$codeSelect = $multiLanguage == 0 ? "code='".$_lang."_advright_bottom'" : "code='vn_advright_bottom' or code='en_advright_bottom'";
$tableCategoryConfig = 'tbl_content_category';
$tableConfig         = 'tbl_content';
$actConfig           = 'advright_bottom';
...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="115" class="title"><a class="title" href="<?php echo getLinkSort(2)?>">Địa chỉ website</a></th>
		<th width="91" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên hiển thị</a></th>
