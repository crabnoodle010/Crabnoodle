...
<?php if ($image_large!=''){ echo '<img border="0" src="../'.$image_large.'" width="100"><br><br>Hình (kích thước lớn)';}?>
				...
				<tr>
					...
					<td width="83%" class="smallfont">
						<input readonly value="<?php echo $name?>" type="text" name="txtName" class="textbox" size="34">					</td>
				</tr>
				...
				<tr>
        			...
        			<td width="83%" class="smallfont">
						<textarea name="txtSubject" cols="80" rows="10" id="txtSubject"><?php echo $subject?>
					</textarea>
					</td>
      			</tr>				
				<tr><td height="10px"></td></tr>
