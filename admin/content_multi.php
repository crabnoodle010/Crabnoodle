...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="25" class="title"><a class="title" href="<?php echo getLinkSort(1)?>">ID</a></th>
		<th width="205" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên khách hàng</a></th>
		<th width="212" class="title"><a class="title" href="<?php echo getLinkSort(2)?>">Địa chỉ</a></th>
		<th width="40" class="title"><a class="title" href="<?php echo getLinkSort(8)?>">Hình ảnh </a></th>
		...
		<th width="74" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="76" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
...
while($row=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td width="26" align="center" bgcolor="<?php echo $color?>" class="smallfont">
			<a 
