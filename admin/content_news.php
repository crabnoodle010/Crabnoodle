...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
	  <th width="24" class="title"><input type="checkbox" name="chkall" onClick="chkallClick(this);"></th>
		...
		<th width="261" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên tin tức</a></th>	
		<th width="55" class="title"><a class="title" href="<?php echo getLinkSort(6)?>">Nội dung ngắn</a></th>
		<th width="50" class="title"><a class="title" href="<?php echo getLinkSort(7)?>">Chi tiết</a></th>
		<th width="50" class="title"><a class="title" href="<?php echo getLinkSort(8)?>">Hình ảnh</a></th>
		<!--<th width="36" class="title"><a class="title" href="<?php echo getLinkSort(9)?>">Hình lớn</a></th>-->
		<th width="45" class="title"><a class="title" href="<?php echo getLinkSort(10)?>">Thứ tự </a></th>
		<th width="49" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
		<!--<th width="65" class="title"><a class="title" href="<?php echo getLinkSort(15)?>">Chọn làm Tin mới</a></th>-->
		<th width="96" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="93" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
...
while($row=mysql_fetch_array($result)){
	...
	<tr>
		...
		<td bgcolor="<?php echo $color?>" class="smallfont" align="center">
			<input type="checkbox" disabled <?php echo $row['status']>0?'checked':''?>>		</td>
		<!--<td bgcolor="<?php echo $color?>" class="smallfont" align="center"><input name="checkbox" type="checkbox" disabled <?php echo $row['new']>0?'checked':''?> /></td>-->
