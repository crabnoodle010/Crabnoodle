...
<table border="1" cellpadding="2" bordercolor="#C9C9C9" width="100%">
	<tr>
		...
		<th width="28" class="title"><a class="title" href="<?php echo getLinkSort(1)?>">ID</a></th>
		<th width="206" class="title"><a class="title" href="<?php echo getLinkSort(2)?>">Tên website</a></th>
		<th width="130" class="title"><a class="title" href="<?php echo getLinkSort(3)?>">Tên hiển thị</a></th>
		<th width="60" class="title"><a class="title" href="<?php echo getLinkSort(8)?>">Hình ảnh</a></th>
		<th width="55" class="title"><a class="title" href="<?php echo getLinkSort(10)?>">Thứ tự sắp xếp</a></th>
		<th width="60" class="title"><a class="title" href="<?php echo getLinkSort(11)?>">Không hiển thị</a></th>
		<th width="100" class="title"><a class="title" href="<?php echo getLinkSort(12)?>">Ngày tạo lập</a></th>
		<th width="96" class="title"><a class="title" href="<?php echo getLinkSort(13)?>">Lần hiệu chỉnh trước</a></th>
		<th width="45" class="title"><a class="title" href="<?php echo getLinkSort(14)?>">Ngôn ngữ</a></th>
	</tr>
